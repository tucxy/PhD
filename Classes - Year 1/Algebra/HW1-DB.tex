...
\textbf{Alert!} In $\ZZ_{n}$, I use $m$ to refer to $[m]$. Also, I use $\class[H]{g}$ or simply $\class{g}$ refer to cosets in $G/H$.
...
\begin{proof}
    ...
    So $\ZZ(p^{\infty})\leq \QQ/\ZZ$. Now consider some integers $i,j\in \ZZ^{+}$ and set $a=1$. Notice that $\frac{1}{p^{i}},\frac{1}{p^{j}}\in (0,1)$. Observe.

    This result essentially follows from \textbf{Problem 2}. $\class{\frac{1}{p^{i}}}=\class{\frac{1}{p^{j}}}\implies \class{\frac{1}{p^{i}}}-\class{\frac{1}{p^{j}}}=\ZZ\implies \frac{1}{p^{i}}-\frac{1}{p^{j}}\in \ZZ$. Well, $\frac{1}{p^{i}},\frac{1}{p^{j}}\in (0,1)\implies \frac{1}{p^{i}}-\frac{1}{p^{j}}\in (-1,1)\implies \frac{1}{p^{i}}-\frac{1}{p^{j}}=0\implies \frac{1}{p^{i}}=\frac{1}{p^{i}}\implies i=j$. On the other hand, $i=j\implies \frac{1}{p^{i}}=\frac{1}{p^{j}}\implies \class{\frac{1}{p^{i}}}=\class{\frac{1}{p^{j}}}$ by definition. So then,
