...
\begin{proof}
    $(\subseteq)$ Recall that since $I,J$ are ideals of $R$, $ir\in I$ and $rj\in J,\;\forall i\in I,\forall j\in J,\forall r\in R$. So then for all $ij\in IJ$, we have that $(i)j\in I$ and $i(j)\in J\implies ij\in I\cap J\implies IJ\cap I\cap J$.
    
    $(\supseteq)$ $I+J=\langle 1\rangle\implies i+j=1$ for some $i\in I,j\in J$. Then for all $a\in I\cap J$, $a=a(1)=(1)a=a(i+j)=ai+aj=ia+ja=(i+j)a$ \end{proof}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 3 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
