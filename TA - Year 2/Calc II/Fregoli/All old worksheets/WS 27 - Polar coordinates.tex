...
Then, from your graph or using the equations from the video/section, convert the points from rectangular to polar coordinates. 
\vfill
\pagebreak
...
$r=1+2 \cos(\theta)$.
\\
\textit{Hint: use Problems 10 and 11 to find the bounds on the integral.}
\vfill
