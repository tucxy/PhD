...
\begin{bigidea} \rm
By the end Chapter 10, we will be able to approximate \emph{any function} by a polynomial, called its \emph{Taylor polynomial}. Polynomials are easy to integrate, so this will help us to evaluate difficult/impossible integrals.
\end{bigidea}
%\medskip
...
\begin{enumerate}
\setcounter{enumi}{4}
\item Classify the sequences in Problem 4 and the geometric sequence $a_n = (\frac{-1}{3})^n$ as bounded above, bounded below, bounded, or none of these.
\end{enumerate}
...
\begin{enumerate}
\setcounter{enumi}{5}
\item Classify the sequences in Problem 4 and the geometric sequence $a_n = (\frac{-1}{3})^n$ as increasing, decreasing, or neither.
