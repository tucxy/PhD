...
\]
\begin{enumerate}
\item \subitem a) Explain why the area of a cross section at $x=a$ $\pi f(a)^2$?
\vfill
\subitem b) Using your answer to a and our method of computing volume via cross section, explain why the whole formula is valid.
\vfill
