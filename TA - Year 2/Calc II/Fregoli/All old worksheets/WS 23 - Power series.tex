...
\begin{enumerate}
%\setcounter{enumi}{-1}
\item Find the {radius of convergence} of the power series  $\displaystyle\sum_{n=0}^{\infty} (-1)^n \displaystyle\frac{n}{4^n}(x+1)^{2n}$.


\vfill

\item Find the {interval of convergence} of the power series in $1$.
